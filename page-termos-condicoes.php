...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
  <section id="terms">
    ...
    <p id="terms__last_update">Ultima modificação: 20 de Outubro de 2021</p>

    <p>Seja bem-vindo a <span>Fox Websites</span>!</p>
    <p>
      Estes termos e condições descrevem as regras de uso do site da empresa
      <span>Fox Websites</span>, localizada no endereço
      <span>https://foxwebsites.com.br</span>.
    </p>
    <p>
      Ao acessar este site, consideramos que você está de acordo com os termos
      e condições abaixo. Não continue a usar o <span>Fox Websites</span> caso
    ...
    <p>
      ...
      internet. Ao acessar o site <span>Fox Websites</span>, você concorda com
      o uso dos cookies requeridos.
    </p>
    <p>
    ...
    <h2>Licença</h2>
    <p>
      Exceto em casos em que for indicado o contrário,
      <span>Fox Websites</span> e seus licenciados têm direito à propriedade
      intelectual de todo o material postado no <span>Fox Websites</span>.
      Todos os direitos à propriedade intelectual são reservados.
    </p>
    <p>Você não tem permissão para:</p>
    <ul>
      <li>
        <p>Copiar ou republicar materiais do <span>Fox Websites</span></p>
      </li>
      <li>
        <p>
          Vender, alugar ou sublocar materiais do <span>Fox Websites</span>
        </p>
      </li>
      <li>
        <p>
          Reproduzir, duplicar ou copiar materiais do
          <span>Fox Websites</span>
        </p>
      </li>
      <li>
        <p>Redistribuir conteúdos do <span>Fox Websites</span></p>
      </li>
      <li>
    ...
    <p>
      ...
      discutir opiniões e informações em determinadas áreas.
      <span>Fox Websites</span> não filtra, edita, publica ou revisa
      Comentários antes que eles sejam apresentados no site. Comentários
      refletem as opiniões da pessoa que os posta. Na extensão em que as leis
      aplicáveis permitem, <span>Fox Websites</span> não se responsabiliza
      legalmente pelos Comentários ou quaisquer danos, riscos ou despesas
      causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência
      dos Comentários deste site.
    </p>
    <p>
      <span>Fox Websites</span> reserva para si o direito de recomer quaisquer
      Comentários que possa ser considerado inapropriado, ofensivo ou quebre
    ...
    <ul>
      ...
      <li>
        <p>
          Os Comentários não serão usados para solicitar ou promover negócios
          ou apresentar atividades comerciais ou atividades ilícitas.
        </p>
      </li>
      <li>
        <p>
          Você por meio deste concede a <span>Fox Websites</span> a licença
          não-exclusiva de usar, reproduzir, editar e autorizar outros a usar,
          reproduzir ou editar qualquer um de seus Comentários em qualquer e
          todas as formas, formatos e mídias.
        </p>
      </li>
    </ul>

    <h2>Criação de links para nosso conteúdo</h2>
    <p>
    ...
    <ul>
      <li>
        <p>Agências governamentais;</p>
      </li>
      <li>
        <p>Mecanismos de busca;</p>
      </li>
      <li>
        <p>Organizações de mídia;</p>
      </li>
      <li>
        <p>
    ...
    <ul>
      <li>
        <p>fontes de informação bem conhecidas sobre produtos e negócios;</p>
      </li>
      <li>
        <p>sites comunitários ponto.com;</p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>distribuidores de diretórios online;</p>
      </li>
      <li>
        <p>portais de internet;</p>
      </li>
      <li>
        <p>firmas de contabilidade, advocacia e consultoria;</p>
      </li>
      <li>
        <p>instituições educacionais e associações de classe.</p>
      </li>
    </ul>
    <p>
      ...
      <span>Fox Websites</span>; e (d) o link será inserido em um contexto
      geral informativo.
    </p>
    <p>
    ...
    <p>
      ...
      informar de seu interesse enviando um e-mail para
      <span>Fox Websites</span>. Por favor, inclua seu some, o nome da sua
      organização e suas informações de contato, assim como a URL do seu site,
      uma lista das URLs do nosso site que você pretende usar como links, e
    ...
    <ul>
      <li>
        <p>Usando nosso nome corporativo; ou</p>
      </li>
      <li>
        <p>Usando a URL para onde o link redireciona; ou</p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      outros elementos visuais da <span>Fox Websites</span> sem um acordo de
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          responsabilidades suas ou nossas que não podem ser excluídas de
