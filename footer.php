        ...
        <div id="footer__content">
            <div id="footer__content__company">
                ...
                <ul id="footer__content__company__social_netwworks">
                    <li>
                        <a href="#">
                            <svg width="20" height="20" viewBox="0 0 22 20" fill="#fff"
            ...
            <div id="footer__content__newsletter">
                <p id="footer__content__newsletter__title">Inscreva-se na Newsletter</p>
...
<div class="modal-container" id="modal_container">
    <div class="modal">
        ...
        <p class="modal__description">Preencha o formulário abaixo para que possamos melhor lhe atender.<br>Em
            algumas horas entraremos em contato com você.</p>
